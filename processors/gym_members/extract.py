"""
Extract gym members data from Kaggle
"""
import os
import subprocess
import sys
from pathlib import Path
from processors.gym_members.config import KAGGLE_DATASET, LOCAL_FILE, RAW_DIR
...
def download_gym_members():
    """Download gym members dataset from Kaggle"""
    print("⏳ Extracting gym members data...")
