"""
Extract body performance data from Kaggle
"""
import os
import subprocess
import sys
from pathlib import Path
from processors.body_performance.config import KAGGLE_DATASET, LOCAL_FILE, RAW_DIR
...
def download_body_performance():
    """Download body performance dataset from Kaggle"""
    print("⏳ Extracting body performance data...")
